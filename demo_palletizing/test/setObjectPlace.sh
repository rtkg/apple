...
{d_type: 1, d_data: [-0.3]}, t_links: [{link_frame: "world", geometries: [{g_type: 3, g_data: [0, 0,
...
g_data: [0, 0, 0]}]}, {link_frame: "world", geometries: [{g_type: 9, g_data: [0.8, 0, 0.13, 0, 0, 1,
0.05]}]}]}, {t_type: 2, priority: 2, is_equality_task: false, task_frame: "world", ds: 0.0, di: 0.1,
dynamics: {d_type: 1, d_data: [-2]}, t_links: [{link_frame: "world", geometries: [{g_type: 8,
