#ifndef HQP_EFFORT_CONTROLLER_H
#define HQP_EFFORT_CONTROLLER_H
...
/**
   ...
   *
   * This class implements the same SoT kinematic control scheme as HQPVelocityController, but also includes the actual velocity tracking, i.e., the outputs are joint efforts
   */
class HQPEffortController: public controller_interface::Controller<hardware_interface::EffortJointInterface>
{
public:
