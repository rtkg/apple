...
{
public:
    Task(unsigned int id, unsigned int priority, std::string const& frame, bool is_equality_task, boost::shared_ptr<TaskDynamics> t_dynamics, std::vector<boost::shared_ptr<TaskLink> > const& t_links);
...
//    static boost::shared_ptr<Task> makeTask(unsigned int id, unsigned int priority, TaskType type, std::string const& sign, boost::shared_ptr<std::vector<TaskLink> > t_objs, boost::shared_ptr<TaskDynamics> t_dynamics); ///<factory method
...
//{
//public:
//    ProjectPointPlane(unsigned int id, unsigned int priority, std::string const& sign, boost::shared_ptr<std::vector<TaskLink> > t_objs, boost::shared_ptr<TaskDynamics> t_dynamics);
