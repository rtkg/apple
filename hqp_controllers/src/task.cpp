...
//---------------------------------------------------------
Task::Task() : priority_(0), name_(""), frame_(""), id_(0), type_(UNDEFINED_TASK), initialized_(false) {}
//---------------------------------------------------------
Task::Task(std::string name, unsigned int id) : priority_(0), name_(name), frame_(""), id_(id), type_(UNDEFINED_TASK), initialized_(false) {}
//---------------------------------------------------------
Task::Task(std::string name, std::string frame, unsigned int id) : priority_(0), name_(name), frame_(frame), id_(id), type_(UNDEFINED_TASK), initialized_(false) {}
//---------------------------------------------------------
