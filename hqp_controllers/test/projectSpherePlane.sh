...
rosservice call /apple/apple_hqp_vel_controller/set_task_objects '{objs: [{root: "citi_truck_base", link: "lbr_iiwa_link_7", geometries: [{type: 10, data: [0.0, 0.0, 0.3, 0.2]}]}, {root: "citi_truck_base", link: "citi_truck_base", geometries: [{type: 3, data: [0.0, 0.0, 1.0, 0.85]}]} ]}'

rosservice call /apple/apple_hqp_vel_controller/visualize_task_objects '{ids: [8, 9]}'

rosservice call /apple/apple_hqp_vel_controller/set_tasks '{tasks: [{type: 9, priority: 2, sign: ">=", t_obj_ids: [8, 9], dynamics: {type: 1, data: [-1.0]}} ]}'
