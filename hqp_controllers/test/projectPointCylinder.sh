...
rosservice call /apple/apple_hqp_vel_controller/set_task_objects '{objs: [{root: "citi_truck_base", link: "lbr_iiwa_link_7", geometries: [{type: 1, data: [0.0, 0.0, 0.0]}]}, {root: "citi_truck_base", link: "citi_truck_base", geometries: [{type: 9, data: [1.00566, -0.8, 0.25, 0.0, 0.0, 1.0, 0.15]}]} ]}'

rosservice call /apple/apple_hqp_vel_controller/visualize_task_objects '{ids: [8, 9]}'

rosservice call /apple/apple_hqp_vel_controller/set_tasks '{tasks: [{type: 6, priority: 1, sign: "=", t_obj_ids: [8, 9], dynamics: {type: 1, data: [-1.0]}} ]}'
